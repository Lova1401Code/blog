...
<body class="w3-light-grey">
    <!-- navbar -->
        ...
        <a class=" w3-btn w3-card-4 w3-dark-gray w3-margin-top" href="index1.php">index</a>
        <a class="w3-btn w3-card-4 w3-margin-top w3-dark-gray" href="apropos.php">à propos</a>
        <a class="w3-btn w3-card-4 w3-margin-top w3-dark-gray" href="contact.php">Contact</a>
