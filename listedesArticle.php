...
<div class="w3-main" style="margin-left:300px;margin-top:43px;">
  ...
  <header class="w3-container" style="padding-top:22px">
    <h2><b><i class="fa fa-dashboard"></i> LISTE DES ARTICLE</b></h2>
</header>
<div class="w3-container w3-margin">
  ...
  ?>
        <tr>
           <td><img src="images/<?php echo $article['nom_fichier']; ?>" alt="photo" class="w3-circle" style="width: 55px; border-radius:10px"></td>
