...
<div class="w3-dark-grey" id="navbar">
  <a href="index3.php?id=<?php echo $_SESSION['id_S']; ?>">index</a>
  <a href="#news">à propos</a>
  <a href="contactvis.php?id=<?php echo $_SESSION['id_S']; ?>">Contact</a>
...
<div class="w3-col l8 s12">
  ...
  <div class="w3-card-4 w3-margin w3-white">
    <img class="" src="images/<?php echo $article4['nom_fichier']; ?>" alt="Nature" height="500px" style="width:100%">
    ...
    <div class="w3-container">
      ...
      <br>
        ...
        <br>
        <p></p>
          <a href="actionS.php?t=1&id=<?= $article4['id_Ar'];?>" class="w3-btn w3-blue w3-wide" id="show">J'aime<span class="w3-tag  w3-white"><?= $like; ?></span></a>
          <a href="actionS.php?t=2&id=<?= $article4['id_Ar'];?>" class="w3-btn w3-dark-grey w3-wide" id="show">Je n'aime pas<span class="w3-tag  w3-white"><?= $dislike; ?></span></a>
        </div>
        <div class="w3-col m6 w3-hide-small">
          ...
          <p>
          <form method="POST" action="commentaireS.php?id=<?php echo $article4['id_Ar']?>" class="w3-group" id="show">
             ...
             while ($art = $recupidarticle2->fetch()) {
               ...
               $idarticle1 = $article4['id_Ar'];
                 if ($idarticle1==$idarticle2) {
                   ?>
                   <tr>
                      <td><img src="images/<?php echo $art['photoA']; ?>" alt="photo" class="avatar" style="vertical-align: middle;width: 50px;height: 50px;border-radius: 50%;"></td>
                      <td>
                      <?php
...
<!--fin zone recherche->
  ...
  <?php
    ...
    <div class="w3-container w3-white">
         ...
         <hr>
         <p><button onclick="document.getElementById('id02').style.display='block'" class="w3-button w3-block w3-dark-gray w3-fixed">Modifier profil</button></p>
         <!-- debut modification -->
