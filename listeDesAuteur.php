...
<div class="w3-main" style="margin-left:300px;margin-top:43px;">
  ...
  <header class="w3-container" style="padding-top:22px">
    <h2><b><i class="fa fa-dashboard"></i> LISTE DES AUTEURS</b></h2>
</header>
<div class="w3-container w3-margin">
  ...
  ?>
        <tr>
           <td><img src="images/<?php echo $auteur['nom_fichierA']; ?>" alt="photo" class="w3-circle" style="width: 55px; border-radius:10px"></td>
           <td><?= $auteur['nom_A'] ?></td>
           <td><?= $auteur['email_A'] ?></td>
           <td class="w3-center"><a href="modificationAuteur.ph" class="w3-btn w3-light-blue">Modifier</a><a href="modificationAuteur.ph" class="w3-btn w3-red w3-paddin">Suprimer</a></td>
        </tr>
