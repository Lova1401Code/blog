<?php
  ...
  if (isset($_POST['chercher'])) {
      ...
      if (isset($_POST['surch']) AND !empty($_POST['surch'])) {
          $recherche = htmlspecialchars($_POST['surch']);
...
<div class="w3-col l8 s12">
    ...
    <div class="w3-container">
      ...
      <div class="w3-row">
        ...
        <p></p>
          ...
          <a href="action.php?t=2&id=<?= $article4['id_Ar'];?>" class="w3-btn w3-black w3-wide" id="show">Je n'aime pas<span class="w3-tag  w3-white"><?= $dislike; ?></span></a>
        </div>
        <div class="w3-col m6 w3-hide-small">
          ...
          <p class="w3-right">
            <a  href="modArticle.php?=<?php echo $article4['id_Ar']; ?>" class="w3-btn w3-black w3-wide">Modifier</a><a href="SuprimerArt.php?id=<?php echo $article4['id_Ar']; ?>" class="w3-btn w3-red w3-wide">Suprimer</a>                      
          </p>
        </div>
            <!--debut commentaire-->
            <div class="w3-col m8">
             ...
             while ($art = $recupidarticle2->fetch()) {
               ...
               $idarticle1 = $article4['id_Ar'];
                 if ($idarticle1==$idarticle2) {
                   echo "<p><b>".$art['nom_Aut'].":</b>".$art['commentaire']."</p>";
                 }
             } 
             ?>
        </div>
  ...
  <form class="modal-content animate" action="ajoutarticle.php" method="post" enctype="multipart/form-data">
    ...
    <div class="container">
      ...
      <label for="psw"><b>contenue de l'article</b></label>
      <textarea type="text" placeholder="entrer contenue..." name="contenue"></textarea><br>
          
      <label for="uname"><b>date de l'ajout</b></label>
      <input type="date" placeholder="date" name="datepub" ><br>
  
      <label class="control-label"><b>Photo de profil</b></label>
      <input class="" type="file" name="photo">

      <button class="b w3-black" type="submit" name="ajouter">Ajouter</button>
    </div>
  </form>
</div>
<!-- END BLOG ENTRIES -->
...
<div class="w3-card w3-margin w3-margin-top">
    <form action="chercher.php" method="POST">
      ...
      <button class="w3-button w3-block w3-black w3-fixed w3-border" name="cherche" >chercher</button>
    </form>
...
<!--fin zone recherche->
  ...
  <?php
    ...
    <img src="images/<?= $suiveur['nom_fichierA'];?>" style="width:100%">
    <div class="w3-container w3-white">
        ...
        <form class="modal-content animate" action="modAuteur.php?id=<?php echo $suiveur['id_A'] ?>" method="post">
          ...
          <div class="container" >
            ...
            <button class="b w3-black" type="submit" name="inscrit">Modifier</button>
          </div>
        </form>
        </div>
         <!-- fin modification -->
...
<!-- END Introduction Menu -->
  ...
  <div class="w3-card w3-padding w3-margin">
   <a class="b w3-button w3-black" href="listearticle.php?id=<?php echo $_SESSION['id_A']; ?>" style="padding: 7px; width: 100%;">Afficher tous mes articles</a>
  </div>
...
<footer class="w3-container w3-dark-grey w3-padding-32 w3-margin-top">
  <button class="w3-button w3-black w3-disabled w3-padding-large w3-margin-bottom">Prec</button>
  <button class="w3-button w3-black w3-padding-large w3-margin-bottom">Suiv »</button>
