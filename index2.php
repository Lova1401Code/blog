...
<div class="w3-dark-grey w3-card-4" id="navbar">
  <a class="w3-btn w3-card-4 w3-margin-left" href="index2.php?id=<?php echo $_SESSION['id_A']; ?>">index</a>
...
<div class="w3-col l8 s12">
  ...
  <div class="w3-card-4 w3-margin w3-white">
    <img class="" src="images/<?php echo $article['nom_fichier']; ?>" alt="Nature" height="500px" style="width:100%">
    <div class="w3-container">
      ...
      while ($auteur = $recupAuteur->fetch()) {
        ...
        $insertnbrlike = $bdd->prepare("UPDATE article SET nbr_reaction=? WHERE id_Ar=?");
        $insertnbrlike->execute(array($like, $idart));
    ...
    <div class="w3-row">
        ...
        <div class="w3-col m6 w3-hide-small">
          ...
          <p>
          <form method="POST" action="commentaire.php?id=<?php echo $article['id_Ar']?>" class="w3-group" id="show">
  ...
  <div id="id03" class="modal w3-card-4">
  ...
  <div class="w3-container w3-blue">
   <h2>Ajout Article</h2>
    ...
    <div class="container">
      ...
      <input class="w3-input" type="text" placeholder="article titre" name="titre" >
...
<div class="w3-card w3-margin w3-margin-top">
    <form action="chercher.php?id=<?php echo $_SESSION['id_A']; ?>" method="POST">
    ...
    <div class="w3-container w3-white">
        ...
        <form class="modal-content animate" action="modAuteur.php?id=<?php echo $suiveur['id_A'] ?>" method="post">
          ...
          <div class="container" >
            ...
            <button class="b w3-dark-grey" style="width: 100%;" type="submit" name="inscrit">Modifier</button>
          </div>
        </form>
        </div>
         <!-- fin modification -->
...
<div class="w3-bar">
  <?php 
     for ($i=1; $i <= $pagetotal; $i++) { 
       echo '<a class=" w3-black w3-border w3-round w3-bar-item w3-button" href="index2.php?page='.$i.'">'.$i.'</a>';
     }
  ?>   
  </div>
